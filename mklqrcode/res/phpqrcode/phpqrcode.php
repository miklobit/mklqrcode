 ...
 */
    ...
    class QRimage {
        ...
        private static function image($frame, $pixelPerPoint = 4, $outerFrame = 4, $back_color = 0xFFFFFF, $fore_color = 0x000000) 
        {
            ...
            // echo 'Back color '.$r2.','.$g2.','.$b2.'\n<br/>';
            // echo 'Back color '.$r1.','.$g1.','.$b1.'\n<br/>';           
 ...
 */
    ...
    class QRvect {
    	...
    	public static function dec2hexrgb($color) {
    		
    		$r = 0xFF & ($color >> 0x10);
    		$g = 0xFF & ($color >> 0x8);
    		$b = 0xFF & $color;
    		$out  = '#'.str_pad(dechex($r), 2, '0', STR_PAD_LEFT);
    		$out .= str_pad(dechex($g), 2, '0', STR_PAD_LEFT);
        ...
        private static function vectSVG($frame, $pixelPerPoint = 4, $outerFrame = 4, $back_color = 0xFFFFFF, $fore_color = 0x000000) 
        {
            ...
            '<desc></desc>'."\n";
                ...
                $backgroundcolor = self::dec2hexrgb($back_color);
                $foregroundcolor = self::dec2hexrgb($fore_color);            
